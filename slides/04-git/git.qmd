...
- Initialize a project.
    ...
    - Create a repository, e.g., `biostat-203b-2024-winter` on GitHub.
...
- Create a private repository `biostat-203b-2024-winter`. Add `Hua-Zhou` and TA team (`tomokiokuno0528` for Lec 1, ) as your collaborators with write permission.
